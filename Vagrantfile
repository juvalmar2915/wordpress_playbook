...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "instance-ubuntu" do |instance_ubuntu|
    instance_ubuntu.vm.box = "ubuntu/focal64"
    # Port forwarding for instance-ubuntu ONLY
    instance_ubuntu.vm.network "forwarded_port", guest: 80, host: 8080
    instance_ubuntu.vm.provision "ansible" do |ansible|
